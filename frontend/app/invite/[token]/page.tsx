...
import { rememberDestination, clearPendingDestination, safePendingDestination } from "../../public-routes";
...
export default function InvitationPage() {
  ...
  useEffect(() => { rememberDestination(`/invite/${token}`); }, [token]);
